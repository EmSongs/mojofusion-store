                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="images/logo/logoblack.png"
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-item">
                                    {{-- <form method="POST" action="{{ route('logout') }}">
                                        @csrf  <!-- Important: Include CSRF token protection -->
                                        <button type="submit">
                                            <div class="icon"><i class="icon-log-out"></i></div>
                                            <div class="text">Logout</div>
                                        </button>
                                    </form> --}}
                                    <a href="{{route('logout')}}" class="" onclick="document.getElementById('logout-form').submit();">
                ...
                <div class="section-content-right">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2024 Mojo Fusion Limited C.I.C</div>
                        </div>
                    </div>
